...
<head>
    ...
    <title> ملتقى القرآن - تسجيل الدخول</title>
...
<body>
    <main class="login-page" aria-label="صفحة تسجيل الدخول">
        <a class="login-home-link" href="index.php">العودة للرئيسية</a>
        <!--right panel-->
        <section class="visual-panel" aria-hidden="true">
            ...
            <blockquote class="verse-text">
                قال تعالى
                <br>
               <span style="font-size:20px"> { ثُمَّ أَوْرَثْنَا الْكِتَابَ الَّذِينَ اصْطَفَيْنَا مِنْ عِبَادِنَا}</span>
...
<!--        Left panel-->
        <section class="form-panel">
            <article class="login-card card" aria-labelledby="portal-title">
                <div class="icon-badge" aria-hidden="true">
                    <svg fill="#3F4A2C" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 484.228 484.228" xml:space="preserve" stroke="#3F4A2C">
                ...
                <header class="card-header">
                    <h1 id="portal-title" style="font-size: 34px ;font-family: 'Cairo', cursive" >ملتقى القرآن</h1>
                ...
                <form class="login-form" action="php/login_process.php" method="POST" novalidate>
                    ...
                    <div class="field-group">
                        ...
                        <input id="password" name="password" type="password" autocomplete="current-password" placeholder="أدخل كلمة المرور">
                    </div>
